...
export default function ExcersieCard(props) {
  ...
  return (
    <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
      ...
      <div className='grid gird-cols-2 sm:grid-cols-4 sm:place-items-center-gap'>
        {['reps','rest','tempo'].map(info => {
          return (
            <div key={info} className='flex flex-col p-2 rounded border-[2px] boder-solid border-slate-900 w-full'>
